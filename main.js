const generateMemeBtm=document.querySelector(".meme_generator .generate_meme_btn");
...
const updateDetails=(url,title,author)=>{
    ...
    memeAuthor.innerHTML=`Meme by: ${author="Arnab Pan"}`;
}
const generateMeme = () => {
...
generateMemeBtm.addEventListener("click",generateMeme);
generateMeme();